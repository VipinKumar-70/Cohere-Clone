...
// //         />
// //       </div>
// //       <div className="2xl:px-40 lg:px-22 px-12">
// //         <div className="relative flex items-center justify-between h-full flex-wrap md:flex-nowrap w-full py-12  font-starcil font-semibold">
// //           <div className="sm:w-3/4 xl:w-[50%] lg:w-[70%]">
// //             <div className="flex gap-3 mb-3">
// //               <p className="">OUR MODELS</p>
// //               <img
...
// //           </div>
// //         </div>
// //         <div className="relative flex items-center justify-between h-full flex-wrap md:flex-nowrap w-full py-12  font-starcil font-semibold bg-[#ffffff96] rounded-3xl flex-row-reverse p-5">
// //           <div className="sm:w-3/4 xl:w-[50%] lg:w-[70%] flex justify-start flex-col 2xl:px-20 lg:px-10 px-3">
...
//           <div className="sm:w-full md:w-3/4 lg:w-[60%] xl:w-[50%] flex justify-start flex-col 2xl:px-20 lg:px-10 px-4">
//             <div className="flex gap-3 items-center text-xs my-2">
//               <p className="p-2 bg-purple-400 rounded-lg">NEW</p>
//               <p>COMMAND</p>
//               <img
